...
class PopupMenuHolder extends StatefulWidget {
  final Widget child;
  ...
  @override
  _PopupMenuHolderState createState() => _PopupMenuHolderState();
}

class _PopupMenuHolderState extends State<PopupMenuHolder> {
